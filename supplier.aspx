<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="supplier.aspx.cs" Inherits="zust_cs5_project.supplier" %>
             ...
             <form id="form1" runat="server">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <asp:TextBox ID="txtsname" CssClass="form-control" placeholder="Supplier Name" required="" runat="server"></asp:TextBox>
                  </div>
                 <div class="form-group">
                    <label>Location</label>
                    <asp:TextBox ID="txtlocation" CssClass="form-control" placeholder="Location" required="" runat="server"></asp:TextBox>
                  </div>
