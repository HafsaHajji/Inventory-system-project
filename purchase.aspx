<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="purchase.aspx.cs" Inherits="zust_cs5_project.purchase" %>
  ...
  <link rel="stylesheet" href="plugins/summernote/summernote-bs4.min.css"/>
    <script>
        function multiply() {
            ...
            let total = document.getElementById("txttotal").value = qty * price;
        }
    </script>
</head>
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label>Supplier Name</label>
                     <asp:DropDownList ID="ddlsuppliername" CssClass="form-control" runat="server">
                   ...
                   <div class="form-group">
                    <label>Item Type</label>
                        <asp:DropDownList ID="ddlitemtype" CssClass="form-control" runat="server">
                            <asp:ListItem>Select Item Type</asp:ListItem>
                            <asp:ListItem>Iphone 16</asp:ListItem>
                            <asp:ListItem>Samsung S1</asp:ListItem>
                       </asp:DropDownList>                

                   </div>
                     <div class="form-group">
                    <label>Qty</label>
                    <asp:TextBox ID="txtqty" CssClass="form-control" placeholder="Qty" required="" TextMode="Number" runat="server"></asp:TextBox>
                  </div>
                    <div class="form-group">
                    <label>Price</label>
                    <asp:TextBox ID="txtprice" onkeyup="multiply()" CssClass="form-control" placeholder="Price" TextMode="Number" required="" runat="server"></asp:TextBox>
                  </div>
                    <div class="form-group">
                    <label>Total Price</label>
                    <asp:TextBox ID="txttotal" CssClass="form-control" ReadOnly="" placeholder="Total Price" required="" TextMode="Number" runat="server"></asp:TextBox>
                  </div>
                  <div class="form-group">
                    <label>Date</label>
             ...
             <asp:Label ID="lblinfo" CssClass="btn btn-success" runat="server"></asp:Label>
              ...
              <asp:GridView ID="GDVUsers" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" runat="server">
                            <Columns>
                                ...
                                <asp:BoundField DataField="ppqty" HeaderText="PRICE"/>
