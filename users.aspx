<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="zust_cs5_project.users" %>
             ...
             <form id="form1" runat="server">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <asp:TextBox ID="txtfullname" CssClass="form-control" placeholder="Fullname" required="" runat="server"></asp:TextBox>
                  </div>
                 <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <asp:TextBox ID="txtpassword" TextMode="Password" CssClass="form-control" placeholder="Password" required="" runat="server"></asp:TextBox>
                  </div>
                  <div class="form-group">
                    <label>Date</label>
                ...
                <div class="row mt-4">
                     ...
                     <div class="col-2">
                 <asp:Button ID="btnsearch" CssClass="btn btn-info" formnovalidate="" runat="server" Text="Search" OnClick="btnsearch_Click" />
